...
export function useWebRTCSession(listingAddress?: string, participants?: ListingParticipant[]) {
  ...
  }, [address, listingAddress, participants, initializeLocalStream, sendSignalingMessage, createPeerConnection])
  ...
  }, [address, listingAddress, localStream])
