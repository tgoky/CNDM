 ...
 * @dev This contract allows splitting Ether payments among a group of accounts. The sender does not need to be aware
 ...
 *
 * `PaymentSplitter` follows a _pull payment model_. This means that payments are not automatically forwarded to the
